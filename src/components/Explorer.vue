  ...
  <div class="relative flex-auto flex flex-col overflow-hidden">
    ...
    <div
      ...
      <div draggable="true"
           ...
           @drop="handleDropZone($event,item)"
           :class="'vf-item-' + randId"
           class="border border-transparent m-1 inline-flex w-[5.5rem] h-20 md:w-24 text-center justify-center select-none"
          ...
          <div>
            <div class="relative mb-2">
              ...
              <svg v-if="item.type === 'file' && (item.hover || handleSelectedIcon(item))" xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 md:h-12 md:w-12 m-auto text-neutral-500" viewBox="0 0 42 42" fill="none">
            ...
            <span class="break-all vf-item-caption" :style="{color: item.type === 'file' && item.hover ? '#BEA9EE' : '#938F99'}">{{ title_shorten(item.basename) }}</span>
          </div>
      </div>
